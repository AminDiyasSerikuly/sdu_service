...
<?php $this->registerJsFile('/backend/web/dashboard/vendor/bootstrap/js/bootstrap.bundle.min.js'); ?>

<!-- Core plugin JavaScript-->
<?php $this->registerJsFile('/backend/web/dashboard/vendor/jquery-easing/jquery.easing.min.js'); ?>

<!-- Custom scripts for all pages-->
<?php $this->registerJsFile('/backend/web/dashboard/js/sb-admin-2.min.js'); ?>

<!-- Page level plugins -->
<?php $this->registerJsFile('/backend/web/dashboard/vendor/chart.js/Chart.min.js'); ?>

<!-- Page level custom scripts -->
<?php $this->registerJsFile('/backend/web/dashboard/js/demo/chart-area-demo.js'); ?>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center"
           href="<?= \yii\helpers\Url::to(['/site/dash-board']) ?>">
            <div class="sidebar-brand-text mx-3">
                ...
                <h6 style="font-size: 80%; margin-top:5px;">AudioRecording</h6>
            </div>
        </a>
        ...
        <li class="nav-item <?= Yii::$app->controller->id == 'user' ? 'active' : '' ?> ">
            <a class="nav-link collapsed" href="<?= \yii\helpers\Url::to(['/user/index']) ?>">
                <i class="fas fa-user"></i>
                <span>Пользователи</span>
            </a>
        </li>
        <li class="nav-item <?= Yii::$app->controller->id == 'book' ? 'active' : '' ?>">
            <a class="nav-link collapsed" href="<?= \yii\helpers\Url::to(['/book/index']) ?>">
